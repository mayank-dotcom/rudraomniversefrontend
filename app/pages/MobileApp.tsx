      ...
      <section className="relative pt-48 pb-20 px-6 md:px-12 bg-mesh overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            >
              Rudranex AI{" "}
              <span className="text-[var(--color-cyan)]">Mobile</span>
            </h1>
            ...
            <p
              ...
              style={{ fontSize: "16px" }}
            >
              Take Rudranex AI wherever you go. Practice interviews, get code assistance, and learn on the move with our native mobile experience.
            </p>
