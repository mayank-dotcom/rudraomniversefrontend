          ...
          <div className="max-w-7xl mx-auto px-6 py-10 md:py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 mb-10">
              ...
              <div className="lg:col-span-4 flex flex-col gap-5">
                  <div className="flex items-center gap-2">
                    <img src="/light.png" alt="Rudranex" className="h-9 w-9 object-contain" />
                    <img src="/light_text.png" alt="Rudranex" className="h-7 md:h-8 w-auto object-contain" />
                  </div>
                <p className="font-sans font-bold uppercase tracking-widest text-[11px] text-black/40">AI Co-Pilot for the Clinical Mind</p>
                <p className="text-sm text-black/50 leading-relaxed max-w-xs">
                  Rudranex is an advanced AI co-pilot designed for clinical practitioners and medical scholars. 
                  Experience high-precision diagnostic support, interactive clinical battle arenas, and state-of-the-art medical resources.
                </p>
              </div>

              {/* Quick Links - 2 cols */}
              <div className="lg:col-span-2">
                <h4 className="text-xs font-semibold uppercase tracking-[0.2em] text-black/60 mb-5">Company</h4>
                <ul className="flex flex-col gap-3">
                  {["About Us", "FAQ", "Support", "Contact Us"].map((link) => (
                    <li key={link}>
                      <a href={`/${link.toLowerCase().replace(/\s+/g, "-")}`} className="text-sm text-black/40 hover:text-black/80 transition-colors">
                        {link}
                      </a>
                    </li>
                  ))}
              ...
              {/* Policy Links - 2 cols */}
              <div className="lg:col-span-2">
                <h4 className="text-xs font-semibold uppercase tracking-[0.2em] text-black/60 mb-5">Policy</h4>
                <ul className="flex flex-col gap-3">
            ...
            {/* Bottom Bar */}
            <div className="pt-3 border-t border-black/5 flex items-center justify-center">
