...
export default function RegularUserAuth() {
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-white/40">
              {mode === "login" ? "Enter your username and password" : "Sign up to get started with Rudranex AI"}
            </p>
          </div>
          ...
          <div className="flex mb-8 bg-white/5 rounded-2xl p-1 border border-white/5">
            <button
              ...
              className={`flex-1 py-3 text-[10px] font-mono uppercase tracking-[0.3em] font-bold rounded-xl transition-all ${
                mode === "login"
